...
# Use drush site:alias-convert to generate yml files needed for drush 9

$root['root'] = dirname(__DIR__). '/web';

$aliases['default'] = $root + array(
  'uri' => 'http://localhost:8080',
);

if (file_exists(__DIR__ . '/aliases.drushrc.local.php')) {
 include __DIR__ . '/aliases.drushrc.local.php';
}
